...
export interface GlobalAPI {
  ...
  /**
   * Register a component globally so it can be resolved even after Vue instance initialization
   * @param name - Component name
   * @param component - Component definition
   */
  defineDynamicComponent: (name: string, component: typeof Component | Object) => void
