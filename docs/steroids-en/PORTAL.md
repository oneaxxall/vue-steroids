...
Vue 2 now has a **Portal** built-in that allows you to render a component to a different location in the DOM, similar to `react-portal` or `portal-vue`, but integrated directly into Vue!

---

## ✨ Use Cases

Portal is very useful for:

- ✅ **Modals & Dialogs** - Render outside the component tree
...
<template>
  <div>
    ...
    <!-- Modal will be rendered to body, not in this component -->
    <portal to="modal">
